...
// ============================================================================
// 이 컴포넌트는 AI Passport의 상세 정보를 표시하며,
// 사용자의 분산신원증명(DID), 지갑 주소, 패스포트 레벨,
// 등록 상태, 성격 프로필, 보안 및 인증 상태, Trust Score     
// 분석 등을 포함합니다. 사용자는 성격 프로필을 편집할 수 있으며,
// 백엔드 연결 상태에 따라 실시간 데이터를 표시합니다.
// 이 컴포넌트는 AI Passport 시스템의 핵심 기능 중 하나로,
// 사용자가 자신의 AI Passport를 관리하고 개인화된 AI 경험을
// 제공할 수 있도록 합니다.
// 이 컴포넌트는 클라이언트 측에서만 렌더링
// (use client)되며, Lucide 아이콘을 사용하여 UI를 구성합니다
// 각 카드 섹션은 Tailwind CSS를 사용하여 스타일링되며,
// 반응형 디자인을 지원합니다.  
// ============================================================================
