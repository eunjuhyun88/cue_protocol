...
// 📱 사이드바 컴포넌트
// ============================================================================
// 이 컴포넌트는 AI Passport 시스템의 사이드바를 구성합니다.
// 사이드바는 사용자의 AI Passport 정보, 데이터 볼트,
// CUE 잔액 등을 표시하며, 다양한 기능에 대한 네비게이션 메뉴
// 를 제공합니다. 모바일 환경에서도 최적화된 레이아웃을 제공하며,
// 사용자가 현재 보고 있는 뷰에 따라 활성화된 메뉴 항목을 강조합니다.
// 사이드바는 사용자의 AI Passport 상태를 시각적으로 나타내며,/
// 백엔드 연결 상태에 따라 실시간 데이터를 표시합니다.
// 또한, 사용자가 선택한 AI 모델에 대한 정보도 표시합니다.
// 이 컴포넌트는 클라이언트 측에서만 렌더링
// (use client)되며, Lucide 아이콘을 사용하여 UI를 구성합니다
// 사이드바는 Tailwind CSS를 사용하여 스타일링되며,
// 반응형 디자인을 지원합니다.
// 이 컴포넌트는 AI Passport 시스템의 핵심 기능 중 하나로,
// 사용자가 다양한 AI Passport 기능에 쉽게 접근할 수 있도록 합니다.
// 이 컴포넌트는 AI Passport 시스템의 다른 부분과 통합되어,
// 사용자가 AI Passport 정보를 쉽게 관리하고, AI 채팅 인터페이스와
// 데이터 볼트 관리 기능에 접근할 수 있도록 합니다.
// ============================================================================
