...
// 💎 CUE 토큰 잔액 표시 컴포넌트
// ============================================================================
// 이 컴포넌트는 사용자의 CUE 토큰 잔액을 시각적으로 표시합니다.
// 사용자의 CUE 잔액, 사용 가능 금액, 잠금된 금액, 대기 중인 금액 등을
// 상세히 보여주며, 백    엔드 연결 상태에 따라 실시간 잔액을
// 표시합니다. 사용자가 잔액 상세 정보를 토글할 수 있는 기능도 포함되어 있습니다.
// CUE 잔액은 다양한 색상 그라데이션으로 표시되며,
// 사용자의 CUE 잔액이 높은 경우 더 화려한 색상으로 강조됩니다.
// 이 컴포넌트는 Tailwind CSS를 사용하여 스타일링되며,
// Lucide 아이콘을 사용하여 시각적으로 풍부한 UI를 제공합니다.
// 사용자는 CUE 잔액의 구성 요소를 시각적으로 이해할 수 있도록
// 사용 가능한, 잠금된, 대기 중인 금액의 비율을 그래픽으로
// 표시합니다. 또한, 최근 업데이트 시간을 표시하여 사용자가
// 잔액 정보가 최신임을 확인할 수 있도록 합니다.
// ============================================================================
