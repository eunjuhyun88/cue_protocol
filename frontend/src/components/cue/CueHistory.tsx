...
// 📊 CUE 토큰 거래 내역 컴포넌트
// ============================================================================
// 이 컴포넌트는 사용자의 CUE 토큰 거래 내역을 시각적으로 표시합니다.
// 사용자가 CUE 토큰을 획득하거나 사용하는 모든 거래를        
// 기록하며, 거래 내역을 필터링하고 검색할 수 있는 기능을 제공합니다.
// 거래 내역은 획득(earned)과 사용(spent)으로 구분되며,
// 각 거래의 소스(예: AI 대화, 마이닝, 인증 등)에 따라
// 아이콘과 색상으로 구분됩니다. 거래 내역은 날짜순으로 정렬되며,
// 각 거래의 세부 정보(목적, 금액, 타임스탬프 등)를
// 상세히 보여줍니다. 또한, 거래 내역의 통계 요약(총 획득, 총 사용, 일평균 등)
//을 제공하여 사용자가 자신의 CUE 토큰 활동을 쉽게 이해할 수 있도록 합니다.
// 이 컴포넌트는 Tailwind CSS를 사용하여 스타일링되며,
// Lucide 아이콘을 사용하여 시각적으로 풍부한 UI를 제공합니다.
// 사용자는 거래 내역을 검색하고 필터링하여 원하는 정보를 쉽게 찾을 수습니다.
// 또한, 백엔드 연결 상태에 따라 실시간 거래 내역을 표시하며,
// 거래 내역을 CSV 파일로 내보내는 기능도 포함되어 있습니다.
// 이 컴포넌트는 클라이언트 측에서만 렌더링
// (use client)되며, React의 상태 관리 훅을 사용하여
// 검색어와 필터링 상태를 관리합니다.
// ============================================================================
