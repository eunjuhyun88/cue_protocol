...
// ✅ 올바른 import 방법import { getDatabaseService, DatabaseService } from '../../services/database/DatabaseService';
import { getDatabaseService } from '../../services/database/DatabaseService';
import { SupabaseService } from '../../services/database/SupabaseService'; // SupabaseService
import { Router, Request, Response } from 'express';
import jwt from 'jsonwebtoken';
import crypto from 'crypto';
import webauthnRoutes from './webauthn';
// SupabaseService가 필요하다면 import 추가
// import { SupabaseService } from '../../services/database/SupabaseService'; // 주석 해제 필요시
...
router.use('/webauthn', webauthnRoutes);  // 👈 이 줄 추가
